...
import ec.edu.espe.edad.ExtractDate;
...
public class Date extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setToolTipText("txtCalculateAge");

        jLabel2.setText("Edad:");
        jLabel2.setToolTipText("txtAge");

        jButton2.setText("Imprimir edad");
        jButton2.setToolTipText("btnPrintAge");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        GregorianCalendar fecha = new GregorianCalendar(1999, 8, 19);
        int day, month, year;
